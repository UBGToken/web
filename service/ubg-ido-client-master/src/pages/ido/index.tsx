...
export const BuyTokenForm: FC = () => {
  ...
  return <form className="BuyTokenForm Form" onSubmit={handleSubmit}>
    ...
    <div className="listNote">
      <p>(*) Let’s share to get 20% all of Claim </p>
      <p>(*) You must buy atleast 50.000 UBG Token to receive comission from Level 2 - Level 7 </p>
      <ul>
        <li>5% of Purchase at Level 1</li>
        <li>4% of Purchase at Level 2</li>
        <li>4% of Purchase at Level 3</li>
        <li>3% of Purchase at Level 4</li>
        <li>2% of Purchase at Level 5</li>
        <li>1% of Purchase at Level 6</li>
        <li>1% of Purchase at Level 7</li>
      </ul>
...
export const ClaimForm: FC = () => {
  ...
  return <form className="ClaimForm Form" onSubmit={handleSubmit}>
    ...
    <div className="listNote">
    <div className="formTitle">Token</div>
      <p>(*) Each Referral friend claims you can 150 token.</p>
      <p>(*) You must buy atleast 10.000 UBG Token to receive comission from Level 2 - Level 3 </p>

      <p>(*) Let’s share to get 25% all of Claim </p>
      <ul>
    ...
    <div className="listNote">
      ...
      <p>(*) Smart contract: 0x9a08b08eb9bdcd94105dd7ea2afd9bb601884a24</p>
